...
if (isset($datos_solicitud)) {
    ...
    $idzona=$resudatos_solicitudlt->idzona;
    $nota=$datos_solicitud->observaciones;
    //$_SESSION['recibido_por']=$datos_solicitud->recibidopor;
    ...
    //$fecha_ent_mensajero= date('d-m-Y', strtotime($fecha_ent_mensajero)); 
    $fecha_liquidacion=date('d/m/Y H:i', strtotime($datos_solicitud->fecha_liquidacion));
    //$fecha_liquidacion= date('d-m-Y', strtotime($fecha_liquidacion)); 
    ...
    <form enctype="multipart/form-data" class="formsolicitud form-horizontal" id="formsolicitud"
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-4 ">
                    <input type="text" id="file" name="file" class="form-control" value="<?php echo $file; ?>" required>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="colaborador" id="colaborador" class="form-control chosen"
                        data-placeholder="Seleccione...">
                        <option value=""></option>
                        <?php foreach ($colaborador as $row): ?>
                        <option value="<?php echo $row->idcolaborador; ?>">
                            <?php echo  $row->idcolaborador.' - '.$row->nombre; ?>
                        </option>
                        <?php endforeach ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="proceso" id="proceso" class="form-control chosen" data-placeholder="Seleccione...">
                        ...
                        <option value="<?php echo $row->idproceso; ?>">
                            <?php echo  $row->idproceso.' - '.$row->descripcion; ?>
                        </option>
                        <?php endforeach ?>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="date" id="fecha_sugerida" name="fecha_sugerida" class="form-control"
                        value="<?php echo $fecha_sugerida; ?>" required>
                </div>

                <label class="col-sm-2 lbl" for="hora_sugerida">Hora:</label>
                <div class="col-sm-3">
                    <input type="time" id="hora_sugerida" name="hora_sugerida" class="form-control"
                        value="<?php echo $horasugerida; ?>" required>
                </div>
            </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="recibido_por" name="recibido_por" class="form-control" readonly
                        value="<?php echo $recibidopor; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" id="fecha_recibe" name="fecha_recibe" class="form-control"
                        value="<?php echo $fecha_recibido; ?>" required readonly>
                </div>
            </div>
                ...
                <div class="col-sm-8">
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="aceptar" value="1"
                            <?php echo($aceptada == 1 ? "checked" : "");?> /> Aceptada</label>

                    <label class="radio-inline">
                        <input type="radio" name="aceptar" value="0"
                            <?php echo($aceptada == 0 ? "checked" : "");?> /> Rechazada</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" rows="2" id="motivo_rechazo" name="motivo_rechazo"
                        placeholder="Motivo de rechazo"><?php echo $motivo_rechazo; ?></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <select name="tipo_viaje" id="tipo_viaje" class="form-control chosen"
                        data-placeholder="Seleccione...">
                        <option value=""></option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <select name="mensajero" id="mensajero" class="form-control chosen"
                        data-placeholder="Seleccione...">
                        <option value=""></option>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="prioridad" id="prioridad" class="form-control chosen"
                        data-placeholder="Seleccione...">
                        <option value=""></option>
            ...
            <div class="form-group">
                ...
                <label class="col-sm-2 " for="proceso"></label>
                <div class="col-sm-2">
                    <div class="checkbox">

                        <label> <input name="cobrada" id="cobrada" type="checkbox" <?php if ($cobrada == 1) {
        echo "checked='checked'";} ?>>Cobrada </label>
                ...
                <div class="col-sm-4">
                    <input type="text" id="valor" name="valor" class="form-control text-right"
                        value="<?php echo $valor; ?>" placeholder="0.00" disabled>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="2" id="justificacion" placeholder="Justificación"
                        disabled><?php echo $justificacion; ?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="documento" name="documento" class="form-control"
                        value="<?php echo $documento; ?>" required placeholder="Introduzca número de documento"
                        disabled>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="consignado_a" name="consignado_a" class="form-control"
                        value="<?php echo $consignadoa; ?>" required placeholder="Consignado a..." disabled>
                </div>
            </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="lugar" name="lugar" class="form-control" value="<?php echo $lugar; ?>"
                        required placeholder="Introduzca lugar de retiro">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="contacto" name="contacto" class="form-control"
                        value="<?php echo $contacto; ?>" required placeholder="Introduzca contacto">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="direccion" name="direccion" class="form-control"
                        value="<?php echo $direccion; ?>" required placeholder="Introduzca dirección">
                </div>
            </div>
        ...
        <div class="form-group col-sm-12">
            <div class="col-sm-1 lbl">Notas:</div>
            <div class="col-sm-10">
                <textarea class="form-control" rows="2" id="observaciones" name="observaciones"
                    placeholder="Observaciones"><?php echo $nota; ?></textarea>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="nombre_mensajero" name="nombre_mensajero" class="form-control"
                        value="<?php echo $nombre_mensajero; ?>" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="2" id="nota_ent_mensajero" name="nota_ent_mensajero"
                        placeholder="Observaciones"><?php echo $nota_ent_mensajero; ?></textarea>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <input type="text" id="fecha_ent_mensajero" name="fecha_ent_mensajero" class="form-control"
                        value="<?php echo $fecha_ent_mensajero; ?>" readonly>
                </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="liquidada_por" id="liquidada_por" class="form-control chosen"
                        data-placeholder="Seleccione...">
                        <option value=""></option>
                        <?php foreach ($colaborador as $row): ?>
                        <option value="<?php echo $row->idcolaborador; ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="date" id="fecha_liquidada" name="fecha_liquidada" class="form-control"
                        value="<?php echo $fecha_liquidada; ?>">
                </div>

                <label class="col-sm-2 lbl" for="hora_liquida">Hora:</label>
                <div class="col-sm-3">
                    <input type="time" id="hora_liquidada" name="hora_liquidada" class="form-control"
                        value="<?php echo $hora_liquidada; ?>">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" rows="2" id="nota_liquidacion" name="nota_liquidacion"
                        placeholder="Observaciones"><?php echo $nota_liquidacion; ?></textarea>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <input type="text" id="fecha_liquidacion" name="fecha_liquidacion" class="form-control"
                        value="<?php echo $fecha_liquidacion; ?>" readonly>
                </div>
...
<div class="row">
    ...
    <div class="col-md-12 text-center">
        <button class="btn btn-success btn-sm" id="btn1" onclick="crear_solicitud(1)"><i
                class="glyphicon glyphicon-ok"></i>
            Guardar</button>

        <button class="btn btn-primary btn-sm" id="btn2" onclick="aceptar_rechazar()"><i
                class="glyphicon glyphicon-ok"></i>
            Guardar</button>

        <button class="btn btn-primary btn-sm" id="btn3" onclick="asignar_mensajero()"><i
                class="glyphicon glyphicon-ok"></i>
            Guardar</button>

        <button class="btn btn-primary btn-sm" id="btn4" onclick="entregado_mensajero()"><i
                class="glyphicon glyphicon-ok"></i>
            Guardar</button>
