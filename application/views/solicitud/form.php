        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                <div class="form-group ">
                    ...
                    <div class="col-sm-4 ">
                        <input type="text" id="file" name="file" class="form-control" value="<?php echo $id_file; ?>"
                            readonly>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="proceso" id="proceso" class="form-control chosen"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="time" id="hora_sugerida" name="hora_sugerida" class="form-control"
                            style="padding-left:0px" value="<?php echo $horasugerida; ?>" required>
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="2" id="justificacion" name="justificacion"
                            placeholder="Justificación" maxlength="120"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="consignado_a" name="consignado_a" class="form-control"
                            value="<?php echo $consignadoa; ?>" required placeholder="Consignado a..." maxlength="100">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="lugar" name="lugar" class="form-control" value="<?php echo $lugar; ?>"
                            required placeholder="Introduzca lugar de retiro" maxlength="120">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="contacto" name="contacto" class="form-control"
                            value="<?php echo $contacto; ?>" required placeholder="Introduzca contacto" maxlength="100">
                    </div>
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="2" id="observaciones" name="observaciones"
                            placeholder="Observaciones" maxlength="120"><?php echo $nota; ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" rows="2" id="motivo_rechazo" name="motivo_rechazo"
                            placeholder="Motivo de rechazo" maxlength="100"><?php echo $motivo_rechazo; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="time" id="hora_entrega" name="hora_entrega" class="form-control"
                            style="padding-left:0px" value="<?php echo $hora_entrega; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="2" id="nota_ent_mensajero" name="nota_ent_mensajero"
                            placeholder="Observaciones" maxlength="100"><?php echo $nota_ent_mensajero; ?></textarea>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="liquidada_por" id="liquidada_por" class="form-control chosen" disabled
                            data-placeholder="Seleccione...">
                            <option value=""></option>
                            <?php foreach ($colaborador as $row) : ?>
                            <option value="<?php echo $row->usuario; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="time" id="hora_liquidada" name="hora_liquidada" class="form-control"
                            style="padding-left:0px" value="<?php echo $hora_liquidada; ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="2" id="nota_liquidacion" name="nota_liquidacion"
                            placeholder="Observaciones" maxlength="100"><?php echo $nota_liquidacion; ?></textarea>
...
<div class="row">
    ...
    <div class="col-md-12 text-center">
        ...
        <button class="btn btn-default btn-sm" onclick="cerrarform('form_solicitud')"><i
                class="glyphicon glyphicon-ok"></i>
            Cancelar</button>
    </div>
...
<script>
    ...
    if ($("#file").val().length <= 0) {
        ...
        $("#proceso.chosen").prop("disabled", false).trigger("chosen:updated");
        $("#colaborador.chosen").prop("disabled", false).trigger("chosen:updated");
    } else {
